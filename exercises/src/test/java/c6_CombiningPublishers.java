...
//        Flux<String> stonks = getStocksGrpc()
//                .or(getStocksRest());
    ...
    public void mail_box_switcher() {
        //todo: feel free to change code as you need
        var primary = mailBoxPrimary().cache();
        Flux<Message> myMail = primary
                .next()
                .flatMapMany(message -> {
        ...
        //fixme c'est moche. je ne pense pas que ce soit ce qui est demandé
